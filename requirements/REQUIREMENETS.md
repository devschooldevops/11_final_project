...
- create a Virtual Machine using Terraform in Azure, install Docker on it, connect to it **via the pipeline** and run the container with the Docker image there;
